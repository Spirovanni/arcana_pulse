  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden flex flex-col">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at top right, #d4af37 0%, transparent 40%), radial-gradient(circle at bottom left, #72dcff 0%, transparent 30%)",
        }}
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          >
            ...
            <h1 className="font-headline text-5xl lg:text-7xl font-light tracking-tight leading-tight text-on-surface">
              ...
              of Your Money, Career, and Future —{" "}
              <span className="text-primary font-normal">In One Place.</span>
            </h1>
            <p className="font-sans text-secondary text-base lg:text-lg leading-relaxed max-w-2xl tracking-wide opacity-80">
              Stop reacting. Start commanding. The Arcana Pulse merges deep
              financial ledgers with career trajectory mapping, powered by
              sovereign AI that works exclusively for your growth.
            </p>
          ...
          >
            <div className="glass-panel rounded-xl p-2 border border-outline-variant/15 shadow-2xl relative">
              ...
              >
                ...
                <div>
                  <div className="text-[10px] text-secondary font-sans uppercase tracking-widest font-bold">
                    Trajectory
                  </div>
      ...
      <footer className="w-full py-12 px-8 bg-[#0e0e0e] border-t border-outline-variant/10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-lg font-black text-secondary font-headline uppercase tracking-tighter">
            Arcana
          </div>
          <div className="flex flex-wrap justify-center gap-6">
            {[
              ...
              <span
                key={item}
                className="font-sans text-[10px] uppercase tracking-widest text-secondary hover:text-tertiary transition-colors cursor-pointer opacity-60 hover:opacity-100"
              >
                {item}
              </span>
            ))}
