...
export default function LandingScreen() {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden flex flex-col pt-16">
      ...
      <nav className="fixed top-0 w-full z-50 glass-panel border-b border-outline-variant/10 shadow-xl bg-gradient-to-b from-[#131313] to-transparent">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-screen-2xl mx-auto">
          ...
          <div className="flex space-x-4 items-center">
            <button onClick={handleLogin} className="text-secondary font-medium hover:text-primary transition-colors hidden md:block">Login</button>
            <button 
              onClick={handleStart}
